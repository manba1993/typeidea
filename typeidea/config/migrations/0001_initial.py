# Generated by Django 2.2.12 on 2020-09-11 10:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diaplay_type', models.PositiveIntegerField(choices=[(1, 'HTML'), (2, '最新文章'), (3, '最热文章'), (4, '最新评论')], default=1, verbose_name='展示类型')),
                ('content', models.CharField(blank=True, help_text='如果设置的不是HTM类型，可以为空', max_length=500, verbose_name='内容')),
